...
function hgcr_muram2em, nmod, dir=dir, time=time, lgt=lgt, t6l=t6l, t6r=t6r, t6m=t6m, resample=resample, offset=offset, vlos=vlos
  ...
  openr,u, "./2D/corona_emission_adj_dem_"+dir+'.'+nmodstr, /get_lun
  a=assoc(u,fltarr(6))
  header=a(0)
