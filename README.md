...
Full documentation, including the quick start guide, the analysis tutorial, and the configuration file reference, is at **[solarc-eclipse.readthedocs.io](https://solarc-eclipse.readthedocs.io)**.
...
See the [documentation](https://solarc-eclipse.readthedocs.io) for the Python API, the full CLI option reference, the configuration file format, and MPI usage.
