...
Full documentation, including the quick start guide, the analysis tutorial, and the configuration file reference, is at **[eclipse.readthedocs.io](https://eclipse.readthedocs.io)**.
...
See the [documentation](https://eclipse.readthedocs.io) for the Python API, the full CLI option reference, the configuration file format, and MPI usage.
